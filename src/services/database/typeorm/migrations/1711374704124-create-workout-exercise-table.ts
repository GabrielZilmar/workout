...
export class CreateWorkoutExerciseTable1711374704124
  implements MigrationInterface
{
  name = 'CreateWorkoutExerciseTable1711374704124';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "workout-exercises" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "workout_id" uuid NOT NULL, "exercise_id" uuid NOT NULL, "order" integer NOT NULL DEFAULT '0', "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_bc695d4fc1a633e4f210ea8fd48" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
